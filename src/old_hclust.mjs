...
//   console.log("color ['#000080', '#ffffff', '#d73027']:", ['#000080', '#ffffff', '#d73027']);
...
//   console.log("innerWidth:", innerWidth);
    ...
    // // Use the exact innerWidth/innerHeight for the overlay heatmap
    ...
    //     .html((event, d) => `
    //       <div style='float: right; color: #1d9a3a;'>
    ...
    gradient.append("stop")
        .attr("offset", "0%")
        .attr("stop-color", "#10a855"); // navy (low)
    ...
    gradient.append("stop")
        .attr("offset", "100%")
        .attr("stop-color", "#d7278b"); // red (high)
